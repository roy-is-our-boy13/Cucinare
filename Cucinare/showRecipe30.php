...
<body>
    ...
    <div class = "center" align = "center">
        ...
        <table>
            ...
            <td>18.) <?php echo$_POST["eighteen"]; ?></td>
            </tr>
            <td>19.) <?php echo$_POST["nineteen"]; ?></td>
            </tr>
            <td>20.) <?php echo$_POST["twenty"]; ?></td>
            </tr>
            <td>21.) <?php echo$_POST["twentyone"]; ?></td>
            </tr>
            <td>22.) <?php echo$_POST["twentytwo"]; ?></td>
            </tr>
            <td>23.) <?php echo$_POST["twentythree"]; ?></td>
            </tr>
            <td>24.) <?php echo$_POST["twentyfour"]; ?></td>
            </tr>
            <td>25.) <?php echo$_POST["twentyfive"]; ?></td>
            </tr>
            <td>26.) <?php echo$_POST["twentysix"]; ?></td>
            </tr>
            <td>27.) <?php echo$_POST["twentyseven"]; ?></td>
            </tr>
            <td>28.) <?php echo$_POST["twentyeight"]; ?></td>
            </tr>
             <td>29.) <?php echo$_POST["twentynine"]; ?></td>
            </tr>
            <td>30.) <?php echo$_POST["thrity"]; ?></td>
            </tr>
            <tr>
