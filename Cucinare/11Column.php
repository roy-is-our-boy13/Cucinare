...
<body>
	...
	<div class = "content">
            ...
            <form id ="ingredientsForm" method = "post", action="showRecipe11.php">
                ...
                <tr>
                    <th><input type="text" placeholder="New Recipe" name="recipeTen"></th>
                </tr>
                <tr>
                ...
                <?php
                    $filename = 'TenCollumsRecipe.txt';
                    $ingridiants = array( $_POST["one"], $_POST["two"], $_POST["three"], $_POST["four"], $_POST["five"], $_POST["six"], $_POST["seven"], $_POST["eight"], $_POST["nine"], $_POST["ten"], $_POST["eleven"]);
                    
                    file_put_contents($filename, $ingridiants);
                ?>
	</div>
    <script> 
