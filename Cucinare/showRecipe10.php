...
<body>
    ...
    <div class = "center" align = "center" >
        <h1>Your New Recipe is <i><?php echo$_POST["recipeTen"]; ?></i></h1>
        ...
        <table>
            ...
            <tr>
                <td><a href="recipeSavedPage.php"><input type="button" for ="submit" onclick = "confirmSubmitted()" class ="submitAndSave" value="Save and Continue"></a></td>
            </tr>
        </table>
     <div id ="bottom" >
     <p>
