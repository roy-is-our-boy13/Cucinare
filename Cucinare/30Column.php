...
<body>
	...
	<div class = "content">
            ...
            <form id ="ingredientsForm" method = "post", action="showRecipe30.php">
                ...
                <tr>
                    <th><input type="text" placeholder="New Recipe" name="recipe30"></th>
                </tr>
                <tr>
                ...
                <tr>
                  <td>21.)<input type="text" placeholder="Enter Ingredients" name="twentyone"></td>
                </tr>
                <tr>
                  <td>22.)<input type="text" placeholder="Enter Ingredients" name="twentytwo"></td>
                </tr>
                <tr>
                  <td>23.)<input type="text" placeholder="Enter Ingredients" name="twentythree"></td>
                </tr>
                <tr>
                  <td>24.)<input type="text" placeholder="Enter Ingredients" name="twentyfour"></td>
                </tr>
                <tr>
                  <td>25.)<input type="text" placeholder="Enter Ingredients" name="twentyfive"></td>
                </tr>
                <tr>
                  <td>26.)<input type="text" placeholder="Enter Ingredients" name="twentysix"></td>
                </tr>
                <tr>
                  <td>27.)<input type="text" placeholder="Enter Ingredients" name="twentyseven"></td>
                </tr>
                <tr>
                  <td>28.)<input type="text" placeholder="Enter Ingredients" name="twentyseight"></td>
                </tr>
                <tr>
                  <td>29.)<input type="text" placeholder="Enter Ingredients" name="twentysnine"></td>
                </tr>
                <tr>
                  <td>30.)<input type="text" placeholder="Enter Ingredients" name="thirty"></td>
                </tr>
                </tr>
                <tr>
